...
class CardsTable extends React.Component {
    ...
    load = (props) => {
        ...
        if (typeof s !== typeof undefined && s !== null) {
            ...
            load_activations(props.from, props.to, props.prefix, props.search, props.value, this.page, (data) => {
                ...
                <div className="content bg-white">
                    ...
                    <div className="col-12">
                        ...
                        <CardsTable
                            ...
                            to={this.state.to}
                            value={this.state.selected.profile_details}
...
class SummaryRow extends React.Component {
    ...
    render() {
        ...
        return (<tr>
            ...
            <td className="col-3"> {summary.profile_details}</td>
            <td className="col-2"> {summary.count}</td>
            <td className="col-2"> {summary.price}</td>
            <td className="col-2"> {summary.price * summary.count}</td>
            <td className="col-2">
...
class CardsSummaryTable extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            activations_summary: this.props.activations_summary,
    ...
    componentWillReceiveProps(newProps) {
        this.setState({
            activations_summary: newProps.activations_summary,
    ...
    render() {
        var total = this.state.activations_summary.reduce((previousValue, currentValue) => {
            ...
            <div>
                <table style={{overflow: 'scroll', width: '90vw'}} className="table table-hover text-center">
                    ...
                    <tr>
                        ...
                        <th className="col-3" scope="col">Profile</th>
                        <th className="col-2" scope="col">Count</th>
                ...
                <div style={{height: '70vh', overflow: 'scroll', width: '90vw'}}>
                    ...
                    <table className="w-100 table table-hover text-center">
                        <tbody className="container-fluid w-100">
                        {this.state.activations_summary.map((item, i) => {
                            return (
                                <SummaryRow
                        ...
                        <tr>
                            <th className="col-1" scope="row"> </th>
...
class ReportView extends React.Component {
    ...
    load = (e) => {
        ...
        load_summary_activations(
            this.state.from,
            this.state.to,
            this.state.prefix, (data) => {
                let activations_summary = data.results;
                console.log(data);
                table.setState({
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <div className="row">
                    <div className="col-12">
                        <h3 className="text-center">Activations Report</h3>
                        <div className="col-12 row">
                            ...
                            <div className="col-2">
                                <p className="p-0 m-0">-</p>
                                <button className="btn btn-light" onClick={this.load}>Search</button>
                            </div>
                        </div>
                        <CardsSummaryTable
                            ...
                            from={this.state.from}
                            to={this.state.to}
                            activations_summary={this.state.activations_summary}
                ...
                {this.state.selected != null ? <CardsView
                    ...
                    value={this.state.selected.profile_details} selected={this.state.selected}
                    prefix={this.state.prefix}
                    from={this.state.from}
                    to={this.state.to}
                /> : ""}
...
let item = document.getElementById("activationsTable");
console.log(item);
